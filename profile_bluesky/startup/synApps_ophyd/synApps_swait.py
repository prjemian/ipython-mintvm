...
def _swait_channels(channel_list):
    ...
    for chan in channel_list:
        defn[chan] = (EpicsSwaitRecordChannel, '', {'letter': chan})
    return defn
...
class EpicsUserCalcsDevice(Device):
    """synApps XXX IOC setup of userCalcs: $(P):userCalc$(N)"""

    enable = Cpt(EpicsSignal, 'userCalcEnable')
    calc1 = Cpt(EpicsSwaitRecord, 'userCalc1')
    calc2 = Cpt(EpicsSwaitRecord, 'userCalc2')
    calc3 = Cpt(EpicsSwaitRecord, 'userCalc3')
    calc4 = Cpt(EpicsSwaitRecord, 'userCalc4')
    calc5 = Cpt(EpicsSwaitRecord, 'userCalc5')
    calc6 = Cpt(EpicsSwaitRecord, 'userCalc6')
    calc7 = Cpt(EpicsSwaitRecord, 'userCalc7')
    calc8 = Cpt(EpicsSwaitRecord, 'userCalc8')
    calc9 = Cpt(EpicsSwaitRecord, 'userCalc9')
    calc10 = Cpt(EpicsSwaitRecord, 'userCalc10')
